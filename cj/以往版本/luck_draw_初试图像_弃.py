...
def out(dic,l):
    ...
    for i in l:
        if i.star=="一星":
            st+='[bot_pic:file:///C:\\Users\\Win\\Desktop\\cj\\图片素材\\一星_加框\\'+str(i)+'_加框.jpg]'
        elif i.star=="二星":
            st+='[bot_pic:file:///C:\\Users\\Win\\Desktop\\cj\\图片素材\\二星_加框\\'+str(i)+'_加框.jpg]'
        elif i.star=="up":
            st+='[bot_pic:file:///C:\\Users\\Win\\Desktop\\cj\\图片素材\\三星_加框\\'+str(i)+'_加框.jpg]'
        else:
            st+='[bot_pic:file:///C:\\Users\\Win\\Desktop\\cj\\图片素材\\三星_加框\\'+str(i)+'_加框.jpg]'
    s=""
    for i in dic:
